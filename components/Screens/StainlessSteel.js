...
export default function StainlessSteelScreen({navigation,route}) {
  if(route?.params?.stack){
   ...
   return (
      <SafeAreaView>
      <ScrollView>
        <ServicesLayout  ScreenContent={StainlessSreelScreenontent} navigation={navigation} stack={stack} />
      </ScrollView>
  </SafeAreaView>
   );
 }
